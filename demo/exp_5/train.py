...
from demo.exp_5.train_module import CompressionLightningModule


def train(epochs=100, batch_size=16, lr=1e-3, latent_dim=16, hidden_dim=256):
    ...
    model = CompressionLightningModule(latent_dim=latent_dim, hidden_dim=hidden_dim, lr=lr, 
                                       vq_weight=0.25, perceptual_weight=0.5)
    
    checkpoint_dir = Path("lightning_logs/exp_5")
    ...
    trainer = L.Trainer(
        ...
        logger=CSVLogger(save_dir="lightning_logs/exp_5", name=""),
