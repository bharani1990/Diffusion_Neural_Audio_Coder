...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", default="lightning_logs/exp_5/checkpoints/last.ckpt")
    ...
    model = lightning_module.codec.to(device)
    model.load_vocoder()
    print("Experiment 5 Codec: Enhanced VQ-VAE + EMA + Residual + Perceptual Loss + HiFi-GAN")
